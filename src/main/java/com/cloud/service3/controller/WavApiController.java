...
public class WavApiController {
    ...
    @GetMapping("test")
    @ResponseBody
    public void wavStream(String text, String format, int sampleRate, String voice,HttpServletRequest request, HttpServletResponse response){
        //文件目录
        File music = restfulDemo.processGETRequest(text, format, sampleRate, voice);
